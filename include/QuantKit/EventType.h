...
public:
    ...
    static const unsigned char OnOrderDone = 125;
    static const unsigned char OnOrderManagerCleared = 126;
    static const unsigned char OnInstrumentDefinition = 127;
    static const unsigned char OnInstrumentDefintionEnd = 128;
    static const unsigned char OnHistoricalData = 129;
    static const unsigned char OnHistoricalDataEnd = 130;
    static const unsigned char OnPortfolioAdded = 131;
    static const unsigned char OnPortfolioDeleted = 132;
    static const unsigned char OnPortfolioParentChanged = 133;
    static const unsigned char HistoricalData = 134;
    static const unsigned char HistoricalDataEnd = 135;
    static const unsigned char BarSlice = 136;
    static const unsigned char OnStrategyEvent = 137;
